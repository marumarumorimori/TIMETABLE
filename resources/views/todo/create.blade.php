...
<form method="POST" action="{{route('todo.store')}}">
  ...
  <div class="creattodo" name="creattodo">
          ...
          <div class="creattodo1">
              <legend for="date">&#10102; 勉強したい日を決める</legend>
              <div class="when1">
                <input type="date" id="date" onchange="showdate()" name="date" required>
              </div>
          </div>
                  ...
                  <ul class="creattodo-timetable-inner">
                    ...
                    <table>
                        <tr>
                          ...
                          <td>
                            <input type="text" name="todostudy1" id="todo1" class="textclass" required>
                          </td>
                        </tr>
                        <tr>
                          <td>2</td>
                          ...
                          <td>
                          <input type="text" name="todostudy2" id="todo2" class="textclass" required>
                          </td>
                        </tr>
                        <tr>
                          <td>3</td>
                          ...
                          <td>
                          <input type="text" name="todostudy3" id="todo3" class="textclass" required>
                          </td>
                        </tr>
                        <tr>
                          <td>4</td>
                          ...
                          <td>
                          <input type="text" name="todostudy4" id="todo4" class="textclass" required>
                          </td>
                        </tr>
                        <tr>
                          <td>5</td>
                          ...
                          <td>
                            <input type="text" name="todostudy5" id="todo5" class="textclass" required>
                          </td>
                        </tr>
                      </table>
